...
```{r ref.label = "office-ratings", echo = FALSE}

```
---
#Code

```{r office-ratings, fig.show = "hide"}
...
```{r ref.label = "office-ratings-num", echo = FALSE}

```
---

```{r office-ratings-num, fig.show = "hide"}
...
```{r ref.label = "office-outlier", echo = FALSE}

```
---
#Code

```{r office-outlier, fig.show = "hide"}
...
```{r ref.label = "office-seasons", echo = FALSE}

```
---
#Code

```{r office-seasons, fig.show = "hide"}
