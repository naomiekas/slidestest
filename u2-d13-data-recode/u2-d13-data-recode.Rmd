...
```{r rel-income, out.width = "50%", echo = FALSE}
...
.panel[.panel-name[Plot]
```{r rel-income-fill, out.width = "50%", echo = FALSE}
ggplot(rel_inc_long, aes(y = religion, x = frequency, fill = income)) +
...
.panel[.panel-name[Plot]
```{r rel-income-fill-viridis, out.width = "50%", echo = FALSE}
ggplot(rel_inc_long, aes(y = religion, x = frequency, fill = income)) +
  geom_col(position = "fill") +
...
.panel[.panel-name[Plot]
```{r rel-income-fill-viridis-minimal, out.width = "50%", echo = FALSE}
ggplot(rel_inc_long, aes(y = religion, x = frequency, fill = income)) +
  geom_col(position = "fill") +
  scale_fill_viridis_d() +
  theme_minimal() 
...
.panel[.panel-name[Plot]
```{r bottom-legend, out.width = "45%", echo = FALSE}
ggplot(rel_inc_long, aes(y = religion, x = frequency, fill = income)) +
  geom_col(position = "fill") +
  scale_fill_viridis_d() +
  theme_minimal() +
...
.panel[.panel-name[Plot]
```{r ref.label = "legend-adjust", echo=FALSE, out.width="40%"}
```
]
...
.panel[.panel-name[Plot]
```{r ref.label = "fix-labels", echo=FALSE, out.width="30%"}
```
]
